# https://github.com/ondrej1024/carelink-python-client/blob/5f85d0e319ed1692bbddb4ddf7e04d616b9566d3/carelink_client2.py
...
class CareLinkClient(object):
   ...
   def _get_data(self, config, token_data, username, role, patientid):
      ...
      try:
          ...
          log.info("_get_data(): couldn't parse the response as JSON :/")
          my_data = None
      return my_data
